        ...
        <div>
          ...
          <div className="relative rounded-md shadow-sm">
            ...
            <input
              ...
              min="0"
              className={`block w-full pl-10 pr-3 py-2 sm:text-sm border ${
                errors.currentStock ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-medical-500 focus:border-medical-500'
              } rounded-md shadow-sm placeholder-gray-400`}
              placeholder="0"
            />
          </div>
        ...
        <div>
          ...
          <div className="relative rounded-md shadow-sm">
            ...
            <input
              ...
              min="0"
              className={`block w-full pl-10 pr-3 py-2 sm:text-sm border ${
                errors.minStock ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-medical-500 focus:border-medical-500'
              } rounded-md shadow-sm placeholder-gray-400`}
              placeholder="20"
            />
          </div>
        ...
        <div>
          ...
          <div className="relative rounded-md shadow-sm">
            ...
            <input
              ...
              onChange={handleChange}
              className={`block w-full pl-10 pr-3 py-2 sm:text-sm border ${
                errors.expiryDate ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-medical-500 focus:border-medical-500'
